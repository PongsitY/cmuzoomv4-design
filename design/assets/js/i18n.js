...
(function () {
  ...
  const DICTIONARY = {
    en: {
      ...
      'admins.addPickOrg': 'Pick an organization to add an admin.',
      ...
      'admins.emptyAll': 'No organization has an admin yet.',
      ...
      'stats.percentUsed': '{percent}% of quota',
      'stats.percentUsedPool': '{percent}% of the shared pool',
    ...
    th: {
      ...
      'admins.addPickOrg': 'เลือกหน่วยงานก่อนเพิ่มผู้ดูแล',
      ...
      'admins.emptyAll': 'ยังไม่มีหน่วยงานใดมีผู้ดูแล',
      ...
      'stats.ofTotal': '{used}/{total}',
      'stats.percentUsed': 'ใช้ไป {percent}% ของโควตา',
      'stats.percentUsedPool': 'ใช้ไป {percent}% ของโควตาส่วนกลาง',
